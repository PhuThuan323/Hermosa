...
<aside className="bg-surfaceAlt text-ink h-full border-r border-border p-4">
  ...
  <h1 className="font-[PlayfairDisplay] text-3xl text-[#2B2B2B] tracking-wide">Hermosa</h1>
      ...
      <nav className="mt-4 space-y-1">
        ...
        <NavLink 
          to="/vouchers" 
          className={({isActive}) =>`${linkBase} ${isActive ? 'bg-primary text-primaryFg shadow-soft' : 'text-ink hover:bg-primary/10 hover:text-primary'}`}>
          {icon("M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M12.5 7a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z M20 8v7 M16 12h8 M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z")} 
          <span>Voucher</span>
        </NavLink>
      </nav>
    </aside>
